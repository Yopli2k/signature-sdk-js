...
Module.onRuntimeInitialized = _ => {
	...
	const key = "3c5427a8-b048-4972-b1a3-a297a7311f95";
	const secret = "nGAtVHhXiydiiUxkqCDye2bq7Gh+M7k+zymCa3kn5OuJiO5xj1XNq0eawd89YUWwNzdGhPQRX1YzqDkaZK/PDA==";
	const promise = mSigObj.setLicence(key, secret);
	console.log("Licence set", key, secret);
